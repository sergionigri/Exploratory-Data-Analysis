...
with(database, {
        plot (database$Datetime, database$Global_active_power, 
        ...
        plot(database$Datetime, database$Voltage, xlab = "datetime", ylab = "Voltage", type = "l")
        plot(database$Datetime, database$Global_reactive_power, xlab = "datetime", 
